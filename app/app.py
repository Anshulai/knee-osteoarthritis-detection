...
st.set_page_config(
    page_title="Detection of Knee-Osteo Arthiritis using ML",
    page_icon=icon,
)
...
with st.sidebar:
    st.image(icon)
    st.subheader("Final Year Project - Detection of KOA")
    st.caption("=== Guidance - Prof. Rakhi Neogi ===")
...
# Body
st.header("Detection of Knee-Osteo Arthiritis using ML")
...
if uploaded_file is not None:
    with col1:
        ...
        if st.button(
            ":arrows_counterclockwise: Predict Arthiritis in the Knee"
        ):
